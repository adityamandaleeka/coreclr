...
struct ThreadLocalModule
{
    ...
    struct DynamicEntry
    {
        ...
        inline PTR_BYTE GetGCStaticsBasePointer()
        {
            ...
            return dac_cast<PTR_BYTE>((PTR_OBJECTREF)((PTRARRAYREF)ObzjectFromHandle(m_pGCStatics))->GetDataPtr());
        }
    ...
    inline PTR_OBJECTREF GetPrecomputedGCStaticsBasePointer()
    {
        ...
        return (PTR_OBJECTREF)((PTRARRAYREF)ObzjectFromHandle(m_pGCStatics))->GetDataPtr();
    }
