                                    ...
                                    )
{
    ...
    *pbstrName = NULL;
    ...
    BEGIN_EXTERNAL_ENTRYPOINT(&hr)
    {
        ...
        if (!pDispMemberInfo || !ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(pDispMemberInfo->m_hndMemberInfo)))
        {
    ...
    *pgrfdex = 0;
    ...
    BEGIN_EXTERNAL_ENTRYPOINT(&hr)
    {
        ...
        GCPROTECT_BEGIN(MemberInfoObj)
        {
            ...
            // If the member does not exist then we return DISP_E_MEMBERNOTFOUND.
            if (!pDispMemberInfo || (MemberInfoObj = ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(pDispMemberInfo->m_hndMemberInfo))) == NULL)
            {
                hr = DISP_E_MEMBERNOTFOUND;
            }
            else
