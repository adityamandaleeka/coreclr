...
PTRARRAYREF DispatchMemberInfo::GetParameters()
{
    ...
    switch (GetMemberType())
    {
        case Method:
        {
            pGetParamsMD = DispatchInfo::GetMethodInfoMD(METHOD__METHOD__GET_PARAMETERS, ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(m_hndMemberInfo))->GetTypeHandle());
        ...
        case Property:
        {
            pGetParamsMD = DispatchInfo::GetPropertyInfoMD(METHOD__PROPERTY__GET_INDEX_PARAMETERS, ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(m_hndMemberInfo))->GetTypeHandle());
    ...
    if (pGetParamsMD != NULL)
    {
        ...
        { 
            ObjToArgSlot(ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(m_hndMemberInfo)))
        };
...
void DispatchExInfo::DeleteMember(DISPID DispID)
{
    ...
    // Take a lock before we check that the member has not already been deleted.
    {
        ...
        if (pDispMemberInfo && (ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(pDispMemberInfo->m_hndMemberInfo)) != NULL))
        {
            OBJECTREF TargetObj = GetReflectionObject();
            GCPROTECT_BEGIN(TargetObj);
            ...
            OBJECTREF MemberInfoObj = ObjectToOBJECTREF(GCHeapUtilities::GetGCHandleTable()->ObjectFromHandle(pDispMemberInfo->m_hndMemberInfo));
