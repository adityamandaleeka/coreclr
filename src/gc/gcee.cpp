...
//     SetSecondaryOnDependentHandle(handle, secondary);
//     return handle;
// }
...
// void GCHandleTable::SetSecondaryOnDependentHandle(OBJECTHANDLE handle, Object* secondary)
// {
//     return SzetDependentHandleSecondary(handle, ObjectToOBJECTREF(secondary));
// }

// Object* GCHandleTable::GetSecondaryOnDependentHandle(OBJECTHANDLE handle)
// {
